...
# %% [markdown]
# ## Finetune Llama-2-70b on an H100
#
# Welcome to this LambdaLabs notebook that shows how to fine-tune the recent Llama-2-70b model on a single GPU.
#
...
dataset_head = dataset_dolphin.take(30000)
questions = []
responses = []
...
dataset_dolphin_train = Dataset.from_pandas(pandas_dataset_dolphin.iloc[0:25000, :])
...
dataset_dolphin_eval = Dataset.from_pandas(pandas_dataset_dolphin.iloc[25000:, :])
# remove old text cols
...
# ## Loading the model
# %% [markdown]
# In this section we will load the [Llama 2 70b model](https://huggingface.co/meta-llama/Llama-2-70b-hf), quantize it in 4bit and attach LoRA adapters on it. Let's get started!
...
# wandb: Currently logged in as: dryanfurman. Use `wandb login --relogin` to force relogin
# wandb: Tracking run with wandb version 0.15.5
# wandb: Run data is saved locally in /home/ubuntu/wandb/run-20230723_071649-kf1llp96
# wandb: Run `wandb offline` to turn off syncing.
# wandb: Syncing run comfy-bee-20 to Weights & Biases (docs)
# wandb: ⭐️ View project at https://wandb.ai/dryanfurman/huggingface
# wandb: 🚀 View run at View run at https://wandb.ai/dryanfurman/huggingface/runs/kf1llp96
